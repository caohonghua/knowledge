...
2. 共享的long和double变量的为什么要用volatile?
...
![java-thread-x-key-volatile-1](/knowledge/assets/images/java/concurrency/volatile/java-thread-x-key-volatile-1.png)
...
![java-thread-x-key-volatile-2](/knowledge/assets/images/java/concurrency/volatile/java-thread-x-key-volatile-2.png)
...
![java-thread-x-key-volatile-3](/knowledge/assets/images/java/concurrency/volatile/java-thread-x-key-volatile-3.png)
