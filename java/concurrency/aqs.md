...
![java-thread-x-juc-aqs-1](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-1.png)
...
![java-thread-x-juc-aqs-2](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-2.png)
...
![java-thread-x-juc-aqs-3](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-3.png)
...
![java-thread-x-juc-aqs-4](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-4.png)
...
![java-thread-x-juc-aqs-5](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-5.png)
...
![java-thread-x-juc-aqs-6](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-6.png)

说明: 经过一系列的方法调用，最后达到的状态是禁用t2线程，因为调用了LockSupport.park

* t1线程调用lock.unlock，其方法调用顺序如下，只给出了主要的方法调用。

![java-thread-x-juc-aqs-7](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-7.png)
...
![java-thread-x-juc-aqs-8](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-8.png)
...
![java-thread-x-juc-aqs-9](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-9.png)
...
![java-thread-x-juc-aqs-10](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-10.png)
...
![java-thread-x-juc-aqs-11](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-11.png)

说明: p2线程调用lock.lock后，会禁止p2线程的继续运行，因为执行了LockSupport.park操作。

* c1线程调用lock.lock，由前面的分析得到如下的最终状态。

![java-thread-x-juc-aqs-12](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-12.png)

说明: 最终c1线程会在sync queue队列的尾部，并且其结点的前驱结点(包含p2的结点)的waitStatus变为了SIGNAL。

* c2线程调用lock.lock，由前面的分析得到如下的最终状态。

![java-thread-x-juc-aqs-13](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-13.png)

说明: 最终c1线程会在sync queue队列的尾部，并且其结点的前驱结点(包含c1的结点)的waitStatus变为了SIGNAL。

* p1线程执行emptyCondition.signal，其方法调用顺序如下，只给出了主要的方法调用。

![java-thread-x-juc-aqs-14](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-14.png)

说明: AQS.CO表示AbstractQueuedSynchronizer.ConditionObject类。此时调用signal方法不会产生任何其他效果。

* p1线程执行lock.unlock，根据前面的分析可知，最终的状态如下。

![java-thread-x-juc-aqs-15](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-15.png)
...
![java-thread-x-juc-aqs-17-1](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-17-1.png)
...
![java-thread-x-juc-aqs-16](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-16.png)

说明: 其中，head设置为包含c1线程的结点，c1继续运行

* c1线程执行fullCondtion.signal，其方法调用顺序如下，只给出了主要的方法调用。

![java-thread-x-juc-aqs-17](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-17.png)
...
![java-thread-x-juc-aqs-18](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-18.png)

说明: 最终c2线程会获取锁资源，继续运行用户逻辑。

* c2线程执行emptyCondition.await，由前面的第七步分析，可知最终的状态如下。

![java-thread-x-juc-aqs-19](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-19.png)
...
![java-thread-x-juc-aqs-20](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-20.png)

* p2继续运行，执行emptyCondition.signal，根据第九步分析可知，最终到达的状态如下。

![java-thread-x-juc-aqs-21](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-21.png)
...
![java-thread-x-juc-aqs-22](/knowledge/assets/images/java/concurrency/aqs/java-thread-x-juc-aqs-22.png)
