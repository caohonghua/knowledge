---
permalink: /java/collection/stack&queue/
---
...
*Deque*的含义是“double ended queue”，即双端队列，它既可以当作栈使用，也可以当作队列使用。下表列出了*Deque*与*Stack*相对应的接口:
...
![cycle-array](/knowledge/assets/images/java/collection/stack&queue/cycle-array.png)
...
![009](/knowledge/assets/images/java/collection/stack&queue/add-first.png)
...
![grow](/knowledge/assets/images/java/collection/stack&queue/grow.png)
...
![add-last](/knowledge/assets/images/java/collection/stack&queue/add-last.png)
