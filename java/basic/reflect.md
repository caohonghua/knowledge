...
![类加载机制流程](/knowledge/assets/images/java/basic/reflect/class-loading-process.png)

2. 类的加载

![类的加载](/knowledge/assets/images/java/basic/reflect/class-loading.png)
...
![反射执行流程](/knowledge/assets/images/java/basic/reflect/reflect-exection-flow.png)
