...
![java-jvm-agent-1](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-1.png)
...
![java-jvm-agent-2](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-2.png)
...
![java-jvm-agent-3](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-3.png)
...
![java-jvm-agent-4](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-4.png)
...
![java-jvm-agent-5](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-5.png)
...
![java-jvm-agent-6](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-6.png)
...
![java-jvm-agent-7](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-7.png)

#### Java-debug-tool与同类产品对比分析

Java-debug-tool的同类产品主要是greys，其他类似的工具大部分都是基于greys进行的二次开发，所以直接选择greys来和Java-debug-tool进行对比。

![java-jvm-agent-8](/knowledge/assets/images/java/jvm/dynamic-debug/java-jvm-agent-8.png)
