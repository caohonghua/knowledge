---
permalink: /java/jvm/detailed-memory-model/
---
...
![java-jmm-1](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-1.png)
...
![java-jmm-2](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-2.png)
...
![java-jmm-3](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-3.png)
...
![java-jmm-4](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-4.png)
...
![java-jmm-5](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-5.png)
...
![java-jmm-6](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-6.png)

如上图所示，A 和 C 之间存在数据依赖关系，同时 B 和 C 之间也存在数据依赖关系。因此在最终执行的指令序列中，C 不能被重排序到 A 和 B 的前面（C 排到 A 和 B 的前面，程序的结果将会被改变）。但 A 和 B 之间没有数据依赖关系，编译器和处理器可以重排序 A 和 B 之间的执行顺序。下图是该程序的两种执行顺序：

![java-jmm-7](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-7.png)
...
![java-jmm-8](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-8.png)
...
![java-jmm-9](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-9.png)
...
![java-jmm-10](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-10.png)
...
![java-jmm-11](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-11.png)

现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：

![java-jmm-12](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-12.png)
...
![java-jmm-13](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-13.png)
...
![java-jmm-14](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-14.png)
...
![java-jmm-15](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-15.png)
...
![java-jmm-16](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-16.png)
...
![java-jmm-17](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-17.png)
...
![java-jmm-18](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-18.png)
...
![java-jmm-19](https://caohonghua.github.io/java-worker/assets/images/java/jvm/detailed-memory-model/java-jmm-19.png)
