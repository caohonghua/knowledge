...
![java-jvm-class-1](/knowledge/assets/images/java/jvm/bytecode/java-jvm-class-1.png)
...
![java-jvm-class-2](/knowledge/assets/images/java/jvm/bytecode/java-jvm-class-2.png)
...
方法来检查传入的Any类型对象是否为空。如果我们扩展的函数为Any?.sayHello()，那么在编译后的文件中则不会有这段字节码的出现
